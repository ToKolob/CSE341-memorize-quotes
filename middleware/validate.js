...
const quotesValidationRules =  [
  ...
  body('work')
    .isString()
    .notEmpty()
    .withMessage('Work is required and must be a string'),
  body('theme')
    .isString()
    .notEmpty()
    .withMessage('Theme is required and must be a string'),
  body('quote')
    .isString()
    .notEmpty()
    .withMessage('Quote is required and must be a string'),
  body('year')
    .isInt({ min: -6000, max: 2100 })
    .withMessage('Year is required and must be a valid integer (e.g., between -6000 and 2100)')
];
...
const validate = (req, res, next) => {
  ...
  contactValidationRules()(req, res, next)
